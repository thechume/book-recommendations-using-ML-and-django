...
class Authors(models.Model):
    ...
    a_name = models.CharField(max_length=35, blank=True, null=True)
...
class Books(models.Model):
    ...
    a = models.ForeignKey(Authors, models.DO_NOTHING)
    genre = models.CharField(max_length=25, blank=True, null=True)
    cat = models.CharField(max_length=25, blank=True, null=True)
...
class ReadBooks(models.Model):
    b = models.ForeignKey(Books, models.DO_NOTHING, primary_key=True)
